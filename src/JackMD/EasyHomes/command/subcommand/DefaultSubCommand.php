...
class DefaultSubCommand extends SubCommand{
	...
	public function getName(): string{
		return Lang::get("command.normal.default.name");
	}
	...
	public function getUsage(): string{
		return Lang::get("command.normal.default.usage");
	}
	...
	public function getDescription(): string{
		return Lang::get("command.normal.default.desc");
	}
	...
	public function execute(CommandSender $sender, array $args): bool{
		/*
		 * Note:
		 * This is just here for counting the usage and description into
		 * the /home help command i.e. the help page of EasyHomes.
		 */
		return true;
	}
}