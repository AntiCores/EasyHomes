...
class GetLimitSubCommand extends SubCommand{
	...
	public function canUse(CommandSender $sender): bool{
		return $sender->hasPermission("eh.command.admin.limit.get");
	}
	...
	public function getName(): string{
		return Lang::get("command.admin.limit.get.name");
	}
	...
	public function getUsage(): string{
		return Lang::get("command.admin.limit.get.usage");
	}
	...
	public function getDescription(): string{
		return Lang::get("command.admin.limit.get.desc");
	}
	...
	public function getAliases(): array{
		return Lang::get("command.admin.limit.get.aliases");
	}
	...
	public function execute(CommandSender $sender, array $args): bool{
		...
		$sender->sendMessage($this->prefix . str_replace(["{player}", "{home_limit}"], [$player->getName(),$this->plugin->getProvider()->getMaxHomes($player->getName())], Lang::get("command.admin.limit.get.success")));
		return true;
	}
}