...
class HelpSubCommand extends SubCommand{
	...
	public function canUse(CommandSender $sender): bool{
		return $sender->hasPermission("eh.command.admin.help");
	}
	...
	public function getName(): string{
		return Lang::get("command.admin.help.name");
	}
	...
	public function getUsage(): string{
		return Lang::get("command.admin.help.usage");
	}
	...
	public function getDescription(): string{
		return Lang::get("command.admin.help.desc");
	}
	...
	public function getAliases(): array {
		return Lang::get("command.admin.help.aliases");
	}
	...
	public function execute(CommandSender $sender, array $args): bool{
		...
		$sender->sendMessage("§dEasyHomes §6Admin §aHelp Page §f[§c" . $pageNumber . "§f/§c" . count($commands) . "§f]");
		foreach($commands[$pageNumber - 1] as $command){
			$sender->sendMessage("§l§c»§r §2" . $command->getUsage() . " §l§b»§r §f" . $command->getDescription());
		}
		$sender->sendMessage(Lang::get("command.admin.help.note"));
		return true;
	}
}