...
class DeleteSubCommand extends SubCommand{
	...
	public function canUse(CommandSender $sender): bool{
		return $sender->hasPermission("eh.command.admin.del");
	}
	...
	public function getName(): string{
		return Lang::get("command.admin.delete.name");
	}
	...
	public function getDescription(): string{
		return Lang::get("command.admin.delete.desc");
	}
	...
	public function getUsage(): string{
		return Lang::get("command.admin.delete.usage");
	}
